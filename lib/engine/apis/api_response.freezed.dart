...
mixin _$ApiResponse<T> {
 ...
 int get statusCode; String? get statusMessage; String? get systemMessage; String? get message; T? get data;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,statusCode,statusMessage,systemMessage,message,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'ApiResponse<$T>(statusCode: $statusCode, statusMessage: $statusMessage, systemMessage: $systemMessage, message: $message, data: $data)';
}
...
@useResult
$Res call({
 int statusCode, String? statusMessage, String? systemMessage, String? message, T? data
});
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? statusCode = null,Object? statusMessage = freezed,Object? systemMessage = freezed,Object? message = freezed,Object? data = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int statusCode,  String? statusMessage,  String? systemMessage,  String? message,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.statusCode,_that.statusMessage,_that.systemMessage,_that.message,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int statusCode,  String? statusMessage,  String? systemMessage,  String? message,  T? data)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.statusCode,_that.statusMessage,_that.systemMessage,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int statusCode,  String? statusMessage,  String? systemMessage,  String? message,  T? data)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.statusCode,_that.statusMessage,_that.systemMessage,_that.message,_that.data);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.statusCode, this.statusMessage, this.systemMessage, this.message, this.data});
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? statusCode = null,Object? statusMessage = freezed,Object? systemMessage = freezed,Object? message = freezed,Object? data = freezed,}) {
